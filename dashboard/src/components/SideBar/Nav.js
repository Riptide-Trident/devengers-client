          ...
          <Collapse in={this.state.mapMenuOpen}>
            ...
            <ul className="nav">
              ...
              <li className={this.isPathActive('/forms/regular-forms') ? 'active' : null}>
                        <Link to="/forms/regular-forms"><i className="pe-7s-news-paper"></i>
            <p>Forms</p></Link>
              </li>
                  ...
                  <div>
                    <ul className="nav">
                      ...
                      <li className={this.isPathActive('/forms/extended-forms') ? 'active' : null}>
                        <Link to="/forms/extended-forms">After Treatment Forms</Link>
                      </li>
                      <li className={this.isPathActive('/forms/validation-forms') ? 'active' : null}>
                        <Link to="/forms/validation-forms">Review Forms</Link>
                      </li>
                    </ul> */}
                  {/* </div>
                </Collapse>
